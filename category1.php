...
<html>
   ...
   <body>
    ...
    <!--displaying Kids products from database-->
    <div class="gradient">
      <?php
      $query="SELECT * FROM product_kids";  // Correct table name
         ...
         <div class="col s12 l3">   
             <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
                ...
                <div class="card-reveal">
                       ...
                       <p>Safe, soft toys and fun stuff for kids. Brings smiles and playtime for little ones and families.</p>
                   </div>
                </div>
             </form>
           </div>
