...
<html>
   <head>
      ...
      /* FIXED: Full image visible - No cropping */
      .card-image {
         height: 220px;
         overflow: hidden;
      }
   ...
   <body>
    ...
    <!--displaying Crockery from database-->
    <div class="gradient">
      <?php
      $query="SELECT * FROM crockery";  // Correct table name
             ...
             <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
                <div class="card small">
                  <div class="card-image waves-effect waves-block waves-light">
                      <!-- FIXED IMAGE PATH -->
                      <img class="activator responsive-img" src="<?php echo $row["img"]; ?>"/>
                  </div>
                ...
                <div class="card-reveal">
                       <span class="card-title grey-text text-darken-4">Crockery<i class="material-icons right">close</i></span>
                       <p>Elevate gifting with our exquisite crockery collection, where every plate and bowl crafts cherished memories for special occasions in your online gift store. Designed for durability and timeless elegance, <br>
                       these pieces blend functionality with stunning aesthetics, making them perfect gifts for housewarmings, weddings, or festive surprises.</p>
                   </div>
                </div>
             </form>
           </div>
