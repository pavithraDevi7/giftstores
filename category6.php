...
<html>
   ...
   <body>
    ...
    <!--displaying Soft Toys from database-->
    <div class="gradient">
      <?php
      $query="SELECT * FROM softtoys";  // Correct table name
             ...
             <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
                <div class="card small">
                  ...
                  <div class="card-content card_color black-text">
                     ...
                     <input type="hidden" name="hidden_category" value="softtoys"/>
                     <input type="hidden" name="item_quantity" value="1">
                </div>
                <div class="card-reveal">
                       <span class="card-title grey-text text-darken-4">Soft Toy<i class="material-icons right">close</i></span>
                       <p>Cuddle up with our soft toys, the perfect gift for endless hugs and joyful moments in your online gift store. These plush companions bring comfort, spark imagination,<br>
                        and create lasting memories for kids and adults alike, ideal for birthdays, festivals, or surprises. </p>
                   </div>
                </div>
             </form>
           </div>
