...
<html>
   ...
   <body>
    ...
    <!--displaying Wallet from database-->
    <div class="gradient">
      <?php
      $query="SELECT * FROM wallet";  // Correct table name
         ...
         <div class="col s12 l3">   
             <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
                ...
                <div class="card-reveal">
                       <span class="card-title grey-text text-darken-4">Wallet<i class="material-icons right">close</i></span>
                       <p>"Style in Every Fold, Gifts That Hold."<br>"Unlock Gifting with Secure Wallets.".</p>
                   </div>
                </div>
             </form>
           </div>
