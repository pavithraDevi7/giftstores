...
<html>
   <head>
      ...
      .card-image img {
         ...
         background: #f5f5f5;  /* Light background for transparency */
      }
      .card.small {
         height: 360px;
      }
   ...
   <body>
    ...
    <!--displaying Phone Cases from database-->
    <div class="gradient">
      <?php
         ...
         <div class="col s12 l3">   
             <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
                ...
                <div class="card-reveal">
                       <span class="card-title grey-text text-darken-4">Phone Case<i class="material-icons right">close</i></span>
                       <p>Fun covers for phones that protect and look cute. Fits any phone, gift for young or old tech fans.</p>
                   </div>
                </div>
             </form>
           </div>
