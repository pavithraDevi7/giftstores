...
<html>
   ...
   <body>
    ...
    <!--displaying Watches from database-->
    <div class="gradient">
      <?php
      $query="SELECT * FROM watch";  // Correct table name
         ...
         <div class="col s12 l3">   
             <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
                ...
                <div class="card-reveal">
                       <span class="card-title grey-text text-darken-4">Watch<i class="material-icons right">close</i></span>
                       <p>Cool watches that tell time with style. Perfect for kids, grown-ups, or anyone who loves looking smart.</p>
                   </div>
                </div>
             </form>
           </div>
