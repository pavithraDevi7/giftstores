...
<html>
   ...
   <body>
    ...
    <!--displaying Home Decor from database-->
    <div class="gradient">
      <?php
      $query="SELECT * FROM homedecor";  // CHANGED: Correct table name
         ...
         <div class="col s12 l3">   
             <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
                ...
                <div class="card-reveal">
                       ...
                       <p>Pretty things for your home – like colorful vases and soft cushions. Easy way to make rooms happy.</p>
                   </div>
                </div>
             </form>
           </div>
