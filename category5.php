...
<html>
   ...
   <body>
    ...
    <!--displaying Jewellery from database-->
    <div class="gradient">
      <?php
      $query="SELECT * FROM jewellery";  // Correct table name
             ...
             <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
                <div class="card small">
                  ...
                  <div class="card-content card_color black-text">
                     ...
                     <input type="hidden" name="hidden_category" value="jewellery"/>
                     <input type="hidden" name="item_quantity" value="1">
                </div>
                <div class="card-reveal">
                       <span class="card-title grey-text text-darken-4">Jewellery<i class="material-icons right">close</i></span>
                       <p>Shiny jewels to make you sparkle every day. Great gifts for all ages – weddings or just fun!.</p>
                   </div>
                </div>
             </form>
           </div>
