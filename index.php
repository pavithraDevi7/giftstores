...
<html>
   ...
   <body>
         ...
         <nav class="black">
            <div class="nav-wrapper">
                ...
                <form action="search.php" method="POST"><!--for search function-->
                  ...
                  <?php
                    ...
                    ?>
                          ...
                          <li><a href="#" class="dropdown-trigger navlink" data-activates="categories1">Categories</li>
                          <li><a href="aboutus.php" class="navlink">About Us</a></li>
                          <li><a href="contactus.php" class="navlink">Contact Us</a></li>
                          <li><a href="admin_customers.php"class="navlink">Customer</a></li>
                          ...
                          <li><a href="shopping_cart.php" class="navlink"><i class="material-icons">shop</i></a></li>
                  ...
                  ?>
                  <li><a href="index.php" class="navlink">Home</a></li>
                  <li><a href="#" class="dropdown-trigger navlink" data-activates="categories1">Categories</a></li>
                  <li><a href="aboutus.php" class="navlink">About Us</a></li>
                  <li><a href="contactus.php" class="navlink">Contact Us</a></li>
                  <li><a href="admin_customers.php"class="navlink">Customer</a></li>
               ...
               <ul class="side-nav" id="mobile-demo"><!--for mobiles-->
                ...
                <li><a href="#" class="dropdown-trigger navlink" data-activates="categories2">Categories</a></li>
    ...
    <div class="slider fullscreen slider_adjust">
        <ul class="slides">
          <li>
            <img src="image/slideone.png"> <!-- random image -->
            <div class="caption left-align">
              <h3 class="-text">Welcome To The GiftStore!</h3>
              <!-- <h5 class="light grey-text text-lighten-3">Here's our small slogan.</h5> -->
            </div>
          </li>
          <li>
            <img src="image/slidetwo.png"> <!-- random image -->
            <div class="caption right-align">
              <h3 class="-text">Get Maximum Opportunities!</h3>
              <!-- <h5 class="light grey-text text-lighten-3">Here's our small slogan.</h5> -->
            </div>
          </li>
          <li>
            <img src="image/slidethree.png"> <!-- random image -->
            <div class="caption right-align">
              <h3 class="-text" >Get Quick Delivery!</h3>
              <!-- <h5 class="light grey-text text-lighten-3">Here's our small slogan.</h5> -->
            </div>
          </li>
        </ul>
      ...
      <!--About-->
      <div class="about" style="padding-top:700px;">
      <center><h1>About US</h1></center>
      <p style="font-size:20px;">
Welcome to GiftStore, your one-stop destination for thoughtful and creative gifts for every occasion. We believe every present carries a special emotion, which is why our collection is carefully handpicked to bring joy, love, and surprise to your loved ones. Whether you are celebrating a birthday, an anniversary, or just want to make someone smile, we make gifting simple, personal, and memorable. Explore our wide range of unique products and let us help you create moments that matter.
      </p>
    ...
    <center><h1> QUICK DELIVERY</h1></center>
      <p style="font-size:20px;">
Experience lightning-fast delivery with GiftStore's Quick Delivery service—same-day, midnight, or fixed-time options available across major cities like Chennai. No more last-minute worries; your thoughtfully chosen gifts arrive fresh and on time, whether for birthdays, anniversaries, or surprises, ensuring every moment is celebrated perfectly. Shop now and enjoy hassle-free, reliable shipping straight to their doorstep.[web:2][web:3]
  </p>
    ...
    <div class="row" style="margin-left: -1px; margin-top: 20px;">
        ...
        <div class="row" style="margin-top: 30px">
          ...
          <div class="col s12 m12 l3">
            <div class="card small anime-start-1" data-as="true"  data-as-animation="anime-end-1" style="opacity: 0.8;">
              <div class="card-image waves-effect waves-block waves-light">
                <img class="activator" src="image/softtoy.png">
              </div>
          ...
          <div class="col s12 m12 l3">
            <div class="card small anime-start-2" data-as="true"  data-as-animation="anime-end-2" style="opacity: 0.8;">
              <div class="card-image waves-effect waves-block waves-light">
                <img class="activator" src="image/crockery.png">
              </div>
          ...
          <div class="col s12 m12 l3">
            <div class="card small anime-start-3" data-as="true"  data-as-animation="anime-end-3" style="opacity: 0.8;">
              <div class="card-image waves-effect waves-block waves-light">
                <img class="activator" src="image/jewellary.png">
              </div>
              <a href="#">
                <div class="card-action center-align black white-text flow-text">
                  Jewellery
          ...
          <div class="col s12 m12 l3">
            <div class="card small anime-start-4" data-as="true"  data-as-animation="anime-end-4" style="opacity: 0.8;">
              <div class="card-image waves-effect waves-block waves-light">
                <img class="activator" src="image/wallet.png">
              </div>
              <a href="#">
                <div class="card-action center-align black white-text flow-text">
                  Wallets
      ...
      <div class="row" style="margin-top: -20px;">
         <footer class="page-footer black white-text">
            ...
            <div class="row center-align">
              <div class="col s12 m12 l12">
                <a href="#" class="link"> Developed By Shobana</a>
              </div>
            </div>
             <div class="row center-align">
                <div class="col s12 m12 l12">
            ...
            <div class="row center-align marginReduce footer-copyright" style="margin-bottom:-20px;">
               <div id="footertext" class="col s12 m12 l12">
                  &copy 2025 Copyright Text .All Rights reserved.
               </div>
            </div>
         </footer>
      </div> 
